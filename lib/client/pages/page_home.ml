        ...
        [ Vdom.Node.div
            ...
            ; Vdom.Node.div
                ...
                [ Vdom.Node.p
                    ...
                    [ Vdom.Node.text
                        "CS @ Stony Brook University. Passionate about HPC infrastructure, cloud tooling, distributed systems, and agentic AI. Prev SWE intern @ GSK, current SWE intern @ CoreWeave."
                    ]
                ; Vdom.Node.div
                    ~attrs:[ Ui.button_row ]
                    ([ Nav_link.create'
